...
**Everything algo 的地形分布**（全题库手感估计，四舍五入到 5%；给 BFS/DFS 当 frontier 零件的不计入，那些记在 Graph 圈）：

| Everything algo | 1-d | 2-d | 树 | 图 | 区间 |
|---|---|---|---|---|---|
| DP | 70% | 15% | 5% | 5% | 5% |
| Binary search / sort | 80% | 5% | — | 5% | 10% |
| Greedy | 70% | 5% | 5% | 5% | 15% |
| Bit mask | 80% | 10% | — | 10% | — |
| Prefix sum | 80% | 10% | 5% | — | 5%（差分） |
| Stack / Queue / heap | 80% | — | 10% | 5% | 5% |
